...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background animate-fade-in">
      ...
      <meta
        name="description"
        content="A peaceful, anonymous space to share and read poetry. Express yourself freely without identity."
      />
      ...
      <main className="container max-w-3xl mx-auto px-4 pb-20">
        ...
        {/* Submit Section */}
        <section
          className="bg-card border border-border rounded-xl p-6 md:p-10 mb-16 shadow-poem animate-slide-in-bottom opacity-0"
        ...
        {/* Divider */}
        <div
          className="flex items-center gap-4 mb-12 animate-fade-in-up opacity-0"
      ...
      {/* Footer */}
      <footer
        className="text-center py-8 border-t border-border animate-fade-in opacity-0"
